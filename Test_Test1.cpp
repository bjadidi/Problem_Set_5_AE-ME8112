...
void Cout_Ax_b (long double A[][5],long double b[],int N);
void P_Bi_CGSTAB (long double A[][5],long double b[],long double T[],int N,int nr);
long double dot_product (int n, long double a_1[], long double b_1[] );
...
void P_Bi_CGSTAB (long double A[][5],long double b[],long double x[],int N,int nr)
{
...
while (errsum > CGTOL)
{
	...
	//update alpha
	alpha=rho/dot_product(N,r_bar,v);
...
// Update omega
	omega = (dot_product(N,kinvt,kinvs))/(dot_product(N,kinvt,kinvt));
